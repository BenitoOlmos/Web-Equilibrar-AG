      ...
      <section id="programs" className="py-20 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="space-y-16 md:space-y-24 mb-24">
            ...
            {/* Program Angustia Block */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center animate-fade-in-down" style={{ animationDelay: '0.4s' }}>
              ...
              <div className="order-2 lg:order-2 lg:pl-12">
                 <span className="block text-brand-primary text-xs tracking-widest uppercase mb-3">Reprogramación Emocional</span>
                 <h3 className="text-3xl md:text-5xl font-serif text-brand-heading mb-4 md:mb-6">Angustia & Vínculo</h3>
                 <p className="text-base md:text-lg text-slate-500 mb-8 leading-relaxed font-light">
                   Redefine tu relación con la incertidumbre. Un viaje de 4 semanas para transformar el miedo a la pérdida en una sólida seguridad interna.
                 </p>
                 <Link 
                   to="/programa-angustia" 
            ...
            {/* Program Culpa Block */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center animate-fade-in-down" style={{ animationDelay: '0.6s' }}>
               <div className="lg:pr-12 order-2 lg:order-1">
                 <span className="block text-brand-primary text-xs tracking-widest uppercase mb-3">Reprogramación Cognitiva</span>
                 <h3 className="text-3xl md:text-5xl font-serif text-brand-heading mb-4 md:mb-6">Culpa & Responsabilidad</h3>
                 <p className="text-base md:text-lg text-slate-500 mb-8 leading-relaxed font-light">
                   Transforma el castigo en responsabilidad soberana. Desactiva el autoataque y recupera tu energía vital para lo que realmente importa.
                 </p>
                 <Link 
                   to="/programa-culpa" 
                   className="w-full md:w-auto inline-flex items-center justify-center px-10 py-4 bg-brand-heading text-white rounded-lg hover:bg-brand-primary transition-all duration-300 shadow-lg hover:shadow-cyan-200/50 text-sm font-bold tracking-wide transform hover:translate-y-1"
            ...
            {/* Program Irritabilidad Block (NEW) */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center animate-fade-in-down" style={{ animationDelay: '0.8s' }}>
              <div className="order-1 lg:order-1">
                 <div className="relative aspect-square md:aspect-square overflow-hidden rounded-sm shadow-luxury group border-4 border-white">
                    <img 
              ...
              <div className="order-2 lg:order-2 lg:pl-12">
                 <span className="block text-brand-primary text-xs tracking-widest uppercase mb-3">Reprogramación de la Calma</span>
                 <h3 className="text-3xl md:text-5xl font-serif text-brand-heading mb-4 md:mb-6">Irritabilidad & Amor Propio</h3>
                 <p className="text-base md:text-lg text-slate-500 mb-8 leading-relaxed font-light">
                   Un proceso focalizado para resignificar la irritabilidad desde el amor propio y la aceptación de la realidad. Deja de luchar contra tu experiencia interna.
                 </p>
                 <Link 
                   to="/programa-irritabilidad" 
                   className="w-full md:w-auto inline-flex items-center justify-center px-10 py-4 bg-brand-heading text-white rounded-lg hover:bg-brand-primary transition-all duration-300 shadow-lg hover:shadow-cyan-200/50 text-sm font-bold tracking-wide transform hover:translate-y-1"
                 >
                   Ver Detalle del Programa
                 </Link>
